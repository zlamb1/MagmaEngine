...
namespace Magma {
	...
	enum class ImageType {
		IMAGE_TYPE_1D, IMAGE_TYPE_2D, IMAGE_TYPE_3D
	};

	enum class ImageTiling {
		DRM_FORMAT_MODIFIER_EXT, LINEAR, OPTIMAL
	};
	...
	enum class ImageUsage {
		...
		TRANSFER_SRC_BIT,
		TRANSFER_DST_BIT,
		DEPTH_STENCIAL_ATTACHMENT_BIT
	};

    inline ImageUsage operator|(const ImageUsage& a, const ImageUsage& b) {
