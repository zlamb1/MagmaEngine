...
VulkanBufferCopy::VulkanBufferCopy(VulkanDevice& pDevice, 
	VkBuffer& pSrc, VkBuffer& pDst) : VulkanOperation(pDevice), pSrc {
	pSrc }, pDst{ pDst } {}
...
namespace BufferCopy {
	...
	VkResult copyBuffer(VulkanDevice* pDevice, VkDeviceSize pSize,
		...
		VulkanBufferCopy vulkanBufferCopy{ *pDevice, pSrc, pDst };
